    ...
    try {
      ...
      if (isEditMode) {
        ...
        if (response.data.success) {
          ...
          navigate(`/blog/${id}`); // Redirect to updated blog
        }
      } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Form */}
        <form onSubmit={submitHandler} className="max-w-3xl mx-auto bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 space-y-8">
          {/* Upload Banner */}
              ...
              <label className="flex flex-col w-full h-32 border-2 border-dashed border-gray-300 hover:border-gray-400 rounded-lg cursor-pointer transition-colors">
                <div className="flex flex-col items-center justify-center pt-7">
                  ...
                  <p className="pt-1 text-sm text-gray-600">
                    {input.banner ? input.banner.name : "Click to upload or drag and drop"}
                  </p>
            ...
            <div className="flex flex-wrap gap-3">
              {["News", "Tech", "LifeStyle", "Politics", "Trending", "Games"].map((tag) => (
                <div
                  ...
                  className={`inline-flex items-center px-3 py-2 rounded-full transition-colors cursor-pointer ${selectedTags.includes(tag)
          ...
          <div className="flex justify-end space-x-4 pt-4">
            ...
            <button
              ...
              className={`px-6 py-2.5 text-sm font-medium text-white rounded-lg transition-colors focus:ring-2 focus:ring-offset-2 ${loading || !input.title || !input.content
            ...
            >
              {loading ? (isEditMode ? "Republishing..." : "Publishing...") : (isEditMode ? "Republish" : "Publish Story")}
            </button>
