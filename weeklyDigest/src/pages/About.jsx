  ...
  return (
    ...
    <hr className="border-gray-300 my-16 max-w-6xl mx-auto" />
      ...
      <div className="max-w-7xl mx-auto flex justify-center space-x-8">
            <a href="https://github.com/Aryan1711-rookie" className="text-gray-500 hover:text-gray-700 transition-colors duration-300">
            ...
            <a href="https://x.com/Aryan_Ti17" className="text-gray-500 hover:text-gray-700 transition-colors duration-300">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
